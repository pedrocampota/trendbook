                ...
                <article
                    ...
                    <div class="wrapper" style="min-width: 50vh;display: flex;margin: 0px;">
                        <div class="col-4" style="">
                            ...
                            <img src="https://images-na.ssl-images-amazon.com/images/I/714hSDOP9YL.jpg" alt="Book Cover"
                            ...
                            <div class="book-info-panel">
                                <div style="margin-bottom: 18px;">
                                    <h1 style="font-weight: 400;font-size: 20px;margin-bottom: 10px;">
                                        <a href="#">Work for Money, Design for Love</a>
                                    </h1>
                                ...
                                <footer class="flex justify-between items-center">
                                    <div class="flex items-center">
                                        ...
                                        <a href="#"><i class="fa-solid fa-heart"
                                                       style="font-size: 18px; color: #ff5053"></i></a>
                                    </div>
                                </footer>
                            </div>
